    ...
    <section style={{ 
      ...
      <div className="container">
        ...
        <div style={{ 
          ...
          <p>
            מעבדת שיניים טופ-טק ברחובות מספקת שירותים מקצועייםבכל הארץ. 
            אנו מתמחים בתותבות שיניים רחובות. 
            המעבדה שלנו ממוקמת בבית הפועלים 6, רחובות ופועלת מעל 40 שנה בתחום.
          </p>
          <h3>שירותי מעבדת השיניים שלנו ברחובות:</h3>
          <ul>
            <li>תותבות שיניים רחובות - תותבות חדשות באותו היום</li>
            <li>תותבות שיניים רחובות - תיקון תותבות תוך חצי שעה</li>
            <li>תותבות שיניים רחובות - ריפודי תותבות במקום</li>
          </ul>
          <p>
